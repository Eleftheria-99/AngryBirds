...
import abnew.heuristics.AbstractHeuristic;
import abnew.utils.PlanTheTrajectory;

/**
*	Destroy as many pigs as possible strategy does exactly what the label says,
* tries to find a trajectory with as many pigs in the way as possible. Interestingly enough, 
* it is also good at going around obstacles as it tries to find the least restrictive way.
*/
public class DestroyAsManyPigsAtOnce extends AbstractHeuristic{
	...
	/**
	    *    Basic constructor.
	    *    It has to have all the information about the game scene, i.e. blocks, hills,pigs, birds, actionRobot, etc.
	    */
	public DestroyAsManyPigsAtOnce(StateOfTheScene currentState, ClientActionRobot actionRobot, TrajectoryPlanner tp) {
		super(currentState, actionRobot, tp);
	 ...
	 /**
	    ...
	    */  	
		...
		{
			_possibleDLTrajectories = new ArrayList<PlanTheTrajectory>();   
		...
		*/
	    ...
	    /**
	    *	This function calculates when to tap for a given bird and given target object.
	    *   This information is later passed to the server.
